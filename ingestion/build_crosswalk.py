...
RISKS = [
    ...
    {"id": "ai-prompt-injection", "title": "AI: Prompt Injection", "layer": "input",
     ...
     "controls": ["owasp-llm-top10:llm01-2025", "mitre-atlas:aml-t0051", "mitre-attack:execution", "owasp-api-top10:api8-2023", "owasp-web-top10:a03-2021", "nist-ai-rmf:measure-2-7", "nist-ai-rmf:manage-2-2", "iso-42001:a6", "iso-42001:a8", "eu-ai-act:art-15", "nist-800-53-r5:si-10", "nist-800-53-r5:ac-3", "nist-800-53-r5:cm-6", "soc2-tsc:cc6-1", "soc2-tsc:cc6-6", "hipaa-security-rule:312-a-1", "hipaa-security-rule:312-b", "nist-ai-600-1:ga-2-9"]},
    {"id": "ai-vector-embedding-weaknesses", "title": "AI: Vector & Embedding Weaknesses", "layer": "input",
     ...
     "controls": ["owasp-llm-top10:llm08-2025", "mitre-atlas:aml-t0020", "mitre-atlas:aml-t0024", "owasp-api-top10:api3-2023", "owasp-web-top10:a01-2021", "nist-ai-rmf:measure-2-7", "nist-ai-rmf:manage-2-2", "iso-42001:a6", "eu-ai-act:art-10", "nist-800-53-r5:si-10", "nist-800-53-r5:sa-11", "nist-800-53-r5:sc-28", "soc2-tsc:cc6-1", "soc2-tsc:cc7-1", "hipaa-security-rule:312-b", "nist-ai-600-1:ga-2-9", "nist-ai-600-1:ga-2-7"]},
    {"id": "ai-sensitive-information-disclosure", "title": "AI: Sensitive Information Disclosure", "layer": "output",
     ...
     "controls": ["owasp-llm-top10:llm02-2025", "mitre-atlas:aml-t0057", "mitre-atlas:aml-t0024", "mitre-attack:t1530", "owasp-api-top10:api3-2023", "owasp-web-top10:a02-2021", "nist-ai-rmf:measure-2-7", "nist-ai-rmf:govern-1-1", "iso-42001:a6", "iso-42001:a8", "eu-ai-act:art-10", "nist-800-53-r5:ac-3", "nist-800-53-r5:sc-28", "nist-800-53-r5:mp-6", "soc2-tsc:cc6-1", "soc2-tsc:cc6-7", "hipaa-security-rule:312-a-1", "hipaa-security-rule:312-e-1", "nist-ai-600-1:ga-2-7", "nist-ai-600-1:ga-2-9"]},
    {"id": "ai-improper-output-handling", "title": "AI: Improper Output Handling", "layer": "output",
     ...
     "controls": ["owasp-llm-top10:llm05-2025", "mitre-atlas:aml-t0048", "mitre-attack:execution", "owasp-api-top10:api7-2023", "owasp-web-top10:a03-2021", "nist-ai-rmf:measure-2-7", "nist-ai-rmf:manage-2-2", "iso-42001:a6", "eu-ai-act:art-15", "nist-800-53-r5:si-10", "nist-800-53-r5:cm-6", "nist-800-53-r5:sa-11", "soc2-tsc:cc6-1", "soc2-tsc:cc7-1", "hipaa-security-rule:312-a-1", "nist-ai-600-1:ga-2-9", "nist-ai-600-1:ga-2-8"]},
    {"id": "ai-misinformation", "title": "AI: Misinformation", "layer": "output",
     ...
     "controls": ["owasp-llm-top10:llm09-2025", "mitre-atlas:aml-t0048", "mitre-atlas:aml-t0047", "nist-ai-rmf:measure-2-11", "nist-ai-rmf:govern-2-1", "iso-42001:a6", "iso-42001:a8", "eu-ai-act:art-13", "nist-800-53-r5:si-10", "nist-800-53-r5:sa-11", "soc2-tsc:cc7-1", "soc2-tsc:cc9-1", "hipaa-security-rule:308-a-1", "nist-ai-600-1:ga-2-8"]},
    {"id": "ai-data-model-poisoning", "title": "AI: Data & Model Poisoning", "layer": "model",
     ...
     "controls": ["owasp-llm-top10:llm04-2025", "mitre-atlas:aml-t0020", "owasp-web-top10:a08-2021", "nist-ai-rmf:measure-2-11", "nist-ai-rmf:map-2-3", "iso-42001:a6", "iso-42001:a7", "eu-ai-act:art-10", "nist-800-53-r5:si-10", "nist-800-53-r5:sa-11", "nist-800-53-r5:cm-6", "soc2-tsc:cc7-1", "soc2-tsc:cc9-1", "hipaa-security-rule:312-b", "nist-ai-600-1:ga-2-9", "nist-ai-600-1:ga-2-12"]},
    {"id": "ai-system-prompt-leakage", "title": "AI: System Prompt Leakage", "layer": "model",
     ...
     "controls": ["owasp-llm-top10:llm07-2025", "mitre-atlas:aml-t0051", "mitre-atlas:aml-t0057", "mitre-attack:credential-access", "owasp-api-top10:api3-2023", "owasp-web-top10:a05-2021", "nist-ai-rmf:measure-2-7", "nist-ai-rmf:govern-1-1", "iso-42001:a6", "eu-ai-act:art-13", "nist-800-53-r5:ac-3", "nist-800-53-r5:sc-28", "nist-800-53-r5:si-10", "soc2-tsc:cc6-1", "soc2-tsc:cc6-7", "hipaa-security-rule:312-a-1", "nist-ai-600-1:ga-2-9"]},
    {"id": "ai-model-theft-extraction", "title": "AI: Model Theft & Extraction", "layer": "model",
     ...
     "controls": ["mitre-atlas:aml-t0007", "mitre-atlas:aml-t0014", "mitre-attack:t1530", "owasp-api-top10:api2-2023", "owasp-web-top10:a01-2021", "nist-ai-rmf:govern-1-1", "nist-ai-rmf:manage-2-2", "iso-42001:a6", "eu-ai-act:art-13", "nist-800-53-r5:ac-3", "nist-800-53-r5:sc-28", "nist-800-53-r5:si-10", "soc2-tsc:cc6-1", "soc2-tsc:cc6-7", "hipaa-security-rule:312-a-1", "nist-ai-600-1:ga-2-9", "nist-ai-600-1:ga-2-12"]},
    {"id": "ai-unbounded-consumption", "title": "AI: Unbounded Consumption", "layer": "infrastructure",
     ...
     "controls": ["owasp-llm-top10:llm10-2025", "mitre-atlas:aml-t0034", "mitre-attack:t1499", "owasp-api-top10:api4-2023", "owasp-web-top10:a05-2021", "nist-ai-rmf:measure-2-7", "nist-ai-rmf:manage-4-1", "iso-42001:a6", "eu-ai-act:art-15", "nist-800-53-r5:sc-5", "nist-800-53-r5:si-10", "nist-800-53-r5:ac-3", "soc2-tsc:cc6-6", "soc2-tsc:cc6-1", "hipaa-security-rule:312-a-1", "hipaa-security-rule:312-e-1", "nist-ai-600-1:ga-2-9"]},
    {"id": "ai-supply-chain", "title": "AI: Supply Chain", "layer": "infrastructure",
     ...
     "controls": ["owasp-llm-top10:llm03-2025", "mitre-atlas:aml-t0010", "mitre-attack:initial-access", "owasp-api-top10:api9-2023", "owasp-web-top10:a06-2021", "nist-ai-rmf:govern-1-1", "nist-ai-rmf:map-2-3", "iso-42001:a6", "iso-42001:a7", "eu-ai-act:art-15", "nist-800-53-r5:sa-12", "nist-800-53-r5:sa-11", "nist-800-53-r5:cm-6", "soc2-tsc:cc9-2", "soc2-tsc:cc6-1", "hipaa-security-rule:308-b-1", "nist-ai-600-1:ga-2-12"]},
    {"id": "ai-api-authentication-access", "title": "AI: API Authentication & Access", "layer": "infrastructure",
     ...
     "controls": ["mitre-atlas:aml-t0012", "mitre-attack:t1190", "owasp-api-top10:api2-2023", "owasp-api-top10:api1-2023", "owasp-web-top10:a01-2021", "owasp-web-top10:a07-2021", "nist-ai-rmf:measure-2-7", "iso-42001:a6", "eu-ai-act:art-15", "nist-800-53-r5:ia-3", "nist-800-53-r5:ac-3", "nist-800-53-r5:sc-28", "soc2-tsc:cc6-1", "soc2-tsc:cc6-3", "hipaa-security-rule:312-a-1", "nist-ai-600-1:ga-2-9"]},
    {"id": "ai-security-misconfiguration", "title": "AI: Security Misconfiguration", "layer": "infrastructure",
     ...
     "controls": ["mitre-attack:t1190", "owasp-api-top10:api7-2023", "owasp-api-top10:api8-2023", "owasp-web-top10:a05-2021", "nist-ai-rmf:manage-4-1", "iso-42001:a6", "eu-ai-act:art-15", "nist-800-53-r5:cm-6", "nist-800-53-r5:sc-7", "nist-800-53-r5:au-2", "soc2-tsc:cc6-1", "soc2-tsc:cc6-6", "hipaa-security-rule:312-a-1", "hipaa-security-rule:308-a-1", "nist-ai-600-1:ga-2-9"]},
    {"id": "ai-excessive-agency", "title": "AI: Excessive Agency", "layer": "agentic",
     ...
     "controls": ["owasp-llm-top10:llm06-2025", "mitre-atlas:aml-t0053", "mitre-atlas:aml-t0054", "mitre-attack:execution", "mitre-attack:t1078", "owasp-api-top10:api5-2023", "owasp-web-top10:a01-2021", "nist-ai-rmf:govern-1-2", "nist-ai-rmf:manage-4-1", "iso-42001:a6", "eu-ai-act:art-14", "nist-800-53-r5:ac-3", "nist-800-53-r5:ac-6", "nist-800-53-r5:cm-7", "soc2-tsc:cc6-1", "soc2-tsc:cc6-3", "hipaa-security-rule:312-a-1", "hipaa-security-rule:308-a-3", "nist-ai-600-1:ga-2-9"]},
    {"id": "ai-agentic-tool-chain-abuse", "title": "AI: Agentic Tool & Chain Abuse", "layer": "agentic",
     ...
     "controls": ["owasp-llm-top10:llm06-2025", "owasp-llm-top10:llm01-2025", "mitre-atlas:aml-t0086", "mitre-atlas:aml-t0110", "mitre-attack:execution", "owasp-api-top10:api5-2023", "owasp-api-top10:api8-2023", "owasp-web-top10:a04-2021", "nist-ai-rmf:govern-1-2", "nist-ai-rmf:manage-2-2", "iso-42001:a6", "iso-42001:a7", "eu-ai-act:art-14", "nist-800-53-r5:ac-3", "nist-800-53-r5:ac-6", "nist-800-53-r5:cm-7", "nist-800-53-r5:sa-11", "soc2-tsc:cc6-1", "soc2-tsc:cc6-3", "hipaa-security-rule:312-a-1", "hipaa-security-rule:308-a-1", "nist-ai-600-1:ga-2-9"]},
    {"id": "ai-insufficient-human-oversight", "title": "AI: Insufficient Human Oversight", "layer": "agentic",
     ...
     "controls": ["owasp-llm-top10:llm06-2025", "mitre-atlas:aml-t0086", "owasp-web-top10:a04-2021", "nist-ai-rmf:govern-1-2", "nist-ai-rmf:measure-2-7", "iso-42001:a6", "iso-42001:a8", "eu-ai-act:art-14", "nist-800-53-r5:ac-3", "nist-800-53-r5:au-2", "nist-800-53-r5:cm-6", "soc2-tsc:cc6-1", "soc2-tsc:cc7-2", "hipaa-security-rule:312-a-1", "hipaa-security-rule:312-b", "nist-ai-600-1:ga-2-9"]},
    {"id": "ai-mcp-connector-tool-abuse", "title": "AI: MCP & Connector Tool Abuse", "layer": "agentic",
     ...
     "controls": ["owasp-llm-top10:llm06-2025", "owasp-llm-top10:llm03-2025", "mitre-atlas:aml-t0110", "mitre-atlas:aml-t0053", "mitre-atlas:aml-t0086", "mitre-attack:execution", "mitre-attack:t1078", "owasp-api-top10:api5-2023", "owasp-api-top10:api8-2023", "owasp-web-top10:a04-2021", "owasp-web-top10:a01-2021", "nist-ai-rmf:govern-1-2", "nist-ai-rmf:manage-2-2", "iso-42001:a6", "iso-42001:a7", "eu-ai-act:art-14", "nist-800-53-r5:ac-6", "nist-800-53-r5:cm-7", "nist-800-53-r5:sa-9", "soc2-tsc:cc6-1", "soc2-tsc:cc6-3", "hipaa-security-rule:312-a-1", "hipaa-security-rule:308-b-1", "nist-ai-600-1:ga-2-12", "nist-ai-600-1:ga-2-9"]},
]
...
MAPPINGS = [
    ...
    ("mitre-atlas:aml-t0051", "nist-ai-rmf:measure-2-7", "related", "strong", "kyora-iq",
    ...
    ("nist-ai-rmf:manage-2-2", "nist-800-53-r5:ca-7", "related", "partial", "kyora-iq",
